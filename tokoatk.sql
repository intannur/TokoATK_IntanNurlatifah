...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=3635469191ltr&server=1">
...
<body>
    <div id="pma_navigation" data-config-navigation-width="231">
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=salesd">`tokoatk`.`salesd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=salesm">`tokoatk`.`salesm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=stockm">`tokoatk`.`stockm`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=stockd">`tokoatk`.`stockd`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=barang">`tokoatk`.`barang`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud22110337&table=log_login">`crud22110337`.`log_login`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud22110337&table=user_log">`crud22110337`.`user_log`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=crud22110337&table=siswa">`crud22110337`.`siswa`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=tokoatk&table=users">`tokoatk`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test&table=daftar">`test`.`daftar`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6629236d4b5672643b474d4f673a4f6a">
...
</span><small>Set to 0 to collapse navigation panel.</small></th><td><input type="number" name="NavigationWidth" id="NavigationWidth" class="custom" value="231"><a class="restore-default hide" href="#NavigationWidth" title="Restore default value"><img src="themes/dot.gif" title="" alt="" class="icon ic_s_reload"></a></td></tr></table>
</fieldset>
